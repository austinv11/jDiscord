...
public class PacketBuilder {
    ...
    public String makeRequest() {
        try {
            ...
            if (type == RequestType.PATCH) {
                try {
                    ...
                    out.writeBytes("PATCH " + url + " HTTP/1.1\n" +
                            ...
                            "User-Agent: jDiscord/??? DiscordBot (https://github.com/NotGGhost/jDiscord, v????)\n" +
            ...
            con.setRequestProperty("User-Agent", "jDiscord/??? DiscordBot (https://github.com/NotGGhost/jDiscord, v????)");
            if (!cookies.equals(""))
